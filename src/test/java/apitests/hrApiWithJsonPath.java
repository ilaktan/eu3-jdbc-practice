...
public class hrApiWithJsonPath {
    ...
    public void test1() {
        ...
        String secondCountryName = jsonPath.get("items.country_name[1]");
        ...
        //List<String> countryNamesWithRegionId3 =response.path("items.findAll {it.region_id==3}.country_id");
    ...
    public void test2() {
        ...
        List<String> firstNames1 = jsonPath.getList("items.findAll{it.job_id==\"IT_PROG\"}.first_name");
        System.out.println("firstNames1 = " + firstNames1);
        List<String> email = jsonPath.getList("items.findAll{it.job_id==\"IT_PROG\"}.email");
        System.out.println("email = " + email);

        String minumumSalary = jsonPath.getString("items.min {it.salary}.first_name");
        System.out.println("minumumSalary = " + minumumSalary);
