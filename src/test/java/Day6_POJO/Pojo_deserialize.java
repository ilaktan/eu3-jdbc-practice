...
public class Pojo_deserialize {
    ...
    public void oneSpartanPojo(){
        Response response = given().accept(ContentType.JSON)
                .pathParam("id", 15)
                .when().get("http://34.234.78.164:8000/api/spartans/{id}");
    ...
    public void regionToPojo(){
        Response response = when().get("http://34.234.78.164:1000/ords/hr/regions");
    ...
    @Test
    public void gson_examle(){

        Gson gson=new Gson();

        //JSON to Java collections or Pojo---> D4-serialization
        String myJsonData="{\n" +
                "    \"id\": 15,\n" +
                "    \"name\": \"Meta\",\n" +
                "    \"gender\": \"Female\",\n" +
       ...
       Map<String,Object> map= gson.fromJson(myJsonData, Map.class);
        ...
        Spartan spartanEU=new Spartan(200,"Mike","Male",411515151);
